...
const CDN_DOMAINS = ['ax', 'cm', 'ct', 'cv', 'cz', 'cw', 'fi', 'sr', 'po', 'py', 'zz'];

const DOWNLOAD_SIZE_LIMIT = 3 * 1024 * 1024 * 1024;
...
client.on('messageCreate', async (message) => {
    if (message.author.id !== "1434475675640791120" &&
        message.author.id !== "797795143746584647" 
       ) return;
