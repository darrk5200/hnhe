...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addStringOption(opt =>
      opt.setName('message')
        .setDescription('Message to display in the ticket embed')
        .setRequired(true)
    )
    .addBooleanOption(opt =>
      opt.setName('support_btn')
        .setDescription('Enable Support button (default: true)')
        .setRequired(false)
    )
    .addBooleanOption(opt =>
      opt.setName('reward_btn')
        .setDescription('Enable Reward button (default: true)')
        .setRequired(false)
    )
    .addBooleanOption(opt =>
      opt.setName('others_btn')
        .setDescription('Enable Others button (default: true)')
        .setRequired(false)
    )
